...
spark = SparkSession.builder \
    .master("spark://de-prac.us-central1-a.c.radiant-psyche-403018.internal:7077") \
    .appName('test') \
    .getOrCreate()
...
df_result.coalesce(1).write.parquet('data/report/script-data/revenue/', mode='overwrite')
